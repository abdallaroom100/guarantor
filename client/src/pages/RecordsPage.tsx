              ...
              {filterType === 'workers' ? (
                ...
                <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredBySearch.map((worker: any, index: number) => {
                ...
                <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredBySearch.map((item: any, index: number) => {
                      // Defensive: handle both Guarantor and Worker-like objects
                      // Only render if item has cardNumber (i.e., is a Guarantor)
