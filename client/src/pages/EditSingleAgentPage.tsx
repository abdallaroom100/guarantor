    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 pt-8" dir="rtl">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white rounded-b-xl shadow-lg p-5 md:p-8">
          ...
          {deleteSuccess && <div className="flex justify-center mt-4"><div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded ">تم حذف الوكيل بنجاح</div></div>}
        </div>
      </div>
      <Modal isOpen={showModal} onClose={() => setShowModal(false)}>
        <div className="text-center">
          <div className="mb-4 text-2xl font-bold text-gray-800">تأكيد حذف التأشيرة</div>
          <div className="mb-6 text-gray-600">هل أنت متأكد أنك تريد حذف هذه التأشيرة؟ لا يمكن التراجع عن هذا الإجراء.</div>
          <div className="flex justify-center gap-4">
            <button onClick={handleDelete} className="px-6 py-2 rounded-lg bg-gradient-to-r from-red-600 to-pink-600 text-white font-bold hover:from-red-700 hover:to-pink-700 transition">تأكيد الحذف</button>
